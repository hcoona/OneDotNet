...
{
    /// <summary>
    /// The Lamport scalar logical clock. Check the paper
    /// "Time, Clocks, and the Ordering of Events in a Distributed System" for further details.
    ...
    public class LamportClock : ILogicalClock<long>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LamportClock"/>
        /// class with given value as its internal counter initial value.
        /// </summary>
        ...
        /// <para><strong>IR1.</strong>Each process P<sub>i</sub>
        /// increments C<sub>i</sub> between any two successive events.</para>
        /// </summary>
        ...
        /// <para><strong>IR2.</strong>(a) If event a is the sending of a message m
        /// by process P<sub>i</sub>, then the message m contains a timestamp
        /// T<sub>m</sub> = C<sub>i</sub>< a >.
        /// (b) Upon receiving a message m, process P<sub>j</sub> sets C<sub>j</sub>
        /// greater than or equal to its present value and greater than T<sub>m</sub>.</para>
        /// </summary>
